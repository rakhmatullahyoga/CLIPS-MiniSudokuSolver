  ...
  {  
   ...
   SudokuDemo() 
     {    
      ...
      resetButton.setToolTipText("ResetTip"); 
      
      solveButton = new JButton("Solve"); 
      solveButton.setActionCommand("Solve");
      buttonGrid.add(solveButton);
      solveButton.addActionListener(this);
      solveButton.setToolTipText("SolveTip"); 
      ...
      techniquesButton.setToolTipText("TechniquesTip"); 
      ...
      JLabel instructions = new JLabel("<html><p style=\"font-size:95%\">" + "Instructions" + "</p><br>");
     ...
     {      
      ...
      /*===============================*/
      ...
      else if (ae.getActionCommand().equals("Techniques"))  
        {
         ...
         JOptionPane.showMessageDialog(jfrm,messageStr,"SolutionTechniques",JOptionPane.PLAIN_MESSAGE);
        }
     } 
